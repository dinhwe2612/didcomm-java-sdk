...
public class VerificationMethodResolver {
     ...
     * @param verificationMethodURL The verification method URL (e.g., "did:example:123#key-1")
     ...
     * @return true if the private key and verification method match, false otherwise
