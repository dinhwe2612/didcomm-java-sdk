package com.pila.credential.common;
...
public class JSONMap extends HashMap<String, Object> {
     ...
     * @param didBaseURL The DID base URL for resolution
     * @throws Exception if proof addition fails
     */
    public void addECDSAProof(String privKeyHex, String verificationMethod, String proofPurpose, String didBaseURL) throws Exception {
        if (this == null) {
            throw new IllegalStateException("JSONMap is null");
        }
     ...
     * @param proof The proof object (can be Map or other)
